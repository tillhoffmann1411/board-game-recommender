...
from ETL.helper import get_bga_ids_of_all_games, get_board_game_names_and_ids, get_bga_publishers
...
class BgaPublisherSpider(scrapy.Spider):
    ...
    names_and_ids = get_bga_publishers()

    start_urls = names_and_ids[0][1]
    ...
    def parse(self, response):
        ...
        publisher_bga_image_url = response.css('.mb-2 .w-100').extract()
